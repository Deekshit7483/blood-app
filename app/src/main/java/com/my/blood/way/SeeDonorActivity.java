...
public class SeeDonorActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.see_donor);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_mapview1_controller = new GoogleMapController(mapview1, new OnMapReadyCallback() {
			...
			public void onMapReady(GoogleMap _googleMap) {
				...
				def_lat = 0;
				def_lon = 0;
				neardy_donor.addListenerForSingleValueEvent(new ValueEventListener() {
					@Override
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						srcLat = 15.7647912d;
						srcLng = 77.4768296d;
						if (ContextCompat.checkSelfPermission(SeeDonorActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
						...
						if (list.size() > 0) {
							...
							SketchwareUtil.showMessage(getApplicationContext(), "No donor");
						}
					}
					@Override
