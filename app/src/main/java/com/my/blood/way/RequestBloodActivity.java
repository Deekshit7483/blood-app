	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				map.put("key", key);
				request_blood.child(key).updateChildren(map);
				finish();
			}
		});
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					if (_childValue.containsKey("email")) {
						edittext3.setText(_childValue.get("email").toString());
					}
					...
					if (_childValue.containsKey("number")) {
						phone.setText(_childValue.get("number").toString());
					}
