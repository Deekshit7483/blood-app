	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				map.put("Lat", edittext2.getText().toString());
				map.put("Lon", edittext3.getText().toString());
				neardy_blood.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(map);
				map.clear();
				finish();
			}
		});
