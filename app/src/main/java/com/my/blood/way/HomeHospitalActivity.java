...
public class HomeHospitalActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.home_hospital);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), AddLocationActivity.class);
				startActivity(i);
			}
		});
		...
		linear3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), ProfileDoctorActivity.class);
				startActivity(i);
			}
		});
		...
		linear8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), AddBloodCampActivity.class);
				startActivity(i);
			}
		});
		...
		_doctor_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					textview13.setText(_childValue.get("username").toString());
