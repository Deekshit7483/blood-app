	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear9.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), NeardyDonorActivity.class);
				startActivity(i);
			}
		});
		...
		linear13.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), ManageActivity.class);
				startActivity(i);
			}
		});
		...
		linear7.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), WantToDonateActivity.class);
				startActivity(i);
			}
		});
		...
		linear11.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				i.setClass(getApplicationContext(), RequestBloodActivity.class);
				startActivity(i);
			}
		});
